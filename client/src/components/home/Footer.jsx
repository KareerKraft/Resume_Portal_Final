...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center justify-center py-6 px-4 text-[13px] text-gray-500 bg-linear-to-r from-white via-green-200/60 to-white w-full">
      <p className="max-w-60 text-center">Making every customer feel valued—no matter the size of your audience.</p>
      <div className="flex items-center gap-4 mt-3">
        ...
        <a href="https://www.linkedin.com/in/kareerkraft-undefined-917b663b6/" target="_blank" rel="noreferrer">
      ...
      <p className="mt-3 text-center">KareerKraft</p>
      <style>{`
